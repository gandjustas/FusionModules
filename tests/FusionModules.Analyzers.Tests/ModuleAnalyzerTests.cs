...
public class ModuleAnalyzerTests
{
    ...
    public Task TypeOnTheEditorConfigAllowList_IsFine() =>
        ...
        AnalyzerTest.VerifyWithOptionAsync<ModuleAnalyzer>("fusion_modules_allowed_public_types", "OrderDto", """
            public class OrderDto { }
            """);

    [Test]
    public Task TypeNotOnTheEditorConfigAllowList_IsReported() =>
        AnalyzerTest.VerifyWithOptionAsync<ModuleAnalyzer>("fusion_modules_allowed_public_types", "SomethingElse", """
